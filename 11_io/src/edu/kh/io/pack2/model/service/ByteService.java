...
public class ByteService {
	...
	public void fileByteOutput() {
		...
		try {
			 ...
			 * content.charAt(i); // i번째 글자 반환 fos.write(ch); // 1byte 출력 스트림이 연결된 파일에 ch에
			 * 쓰기 }
			 */
	...
	public void bufferedFileByteOutput() {
		 ...
		 * 
		 * - FileOutputStrem은 1바이트씩 데이터를 입출력
		 * 
		 * - BufferedOutputStream / BufferedInputStream
	...
	public void bufferedFileByteInput() {
		...
		try {
			...
			try { // 보조 스트림만 close() 해도 기반 스트림도 같이 close() 
	 ...
	 * 
	 * 1) 입력된 경로에 파일이 있는 지 검사 : File.exists()
	 * 
