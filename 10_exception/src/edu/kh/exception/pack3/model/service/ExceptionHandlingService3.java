...
public class ExceptionHandlingService3 {
	 ...
	 * -> 예외 처리 구문(try ~ catch, throws)을 써도 되고 안써도 되는 예외
	 *
	 */
	 ...
	 */
	public void method4() {
		// inputString()을 메서드를 이용해서
		// 문자열을 두 번 입력받아 하나로 합쳐서 출력하기
...
//			System.out.println(str1 + str2); // 효율이 별로
