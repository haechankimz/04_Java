...
public class StudentService {
	...
	public Student selectName(String name) {
		...
		// students 객체 배열을 순차 접근 하여 null이 아니면서
		// 학생이름이 name과 일치하는 학생 찾아 return
		
		/***** 향상된 for문 *****/
		
		// for(변수 : 배열 || 컬렉션)
		
		// - 배열 || 컬렉션 의 요소를 처음 부터 끝까지 순차 접근하는 for문
		// - 매 반복 마다 배열 || 컬렉션 요소를 하나씩 꺼내와 변수에 저장
