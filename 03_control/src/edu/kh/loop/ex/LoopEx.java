...
public class LoopEx {
	...
	public void method2() {
		...
		int input1 = sc.nextInt(); // 첫 번째
		int input2 = sc.nextInt(); // 두 번째
	...
	/**
	 * 두 수를 입력 받아서 반복출력하는 구문을 작성
	 * 
	 * (첫 번째 입력 A, 두 번째 입력 B)
	 * 
	 * 조건 1 : B가 A보다 큰 경우 -> A ~ B 까지 1씩 증가하며 출력
	 * 조건 2 : A가 B보다 큰 경우 -> B ~ A 까지 1씩 감소하며 출력
	...
	public void method5b() {
		...
		int max = Math.min(a, b); // 두 수 중 큰 값을 반환
